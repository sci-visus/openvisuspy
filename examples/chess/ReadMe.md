...
while [[ "1" == "1" ]] ; do
python -m panel serve dashboards/app    \
   --port ${BOKEH_PORT} \
   --use-xheaders \
...
python -m bokeh serve dashboards/app --dev --args "C:\big\visus_datasets\chess\test-group\config.json"
python -m bokeh serve dashboards/app --dev --args "https://nsdf01.classe.cornell.edu/test-group.json"
```
...
python -m bokeh serve dashboards/app --dev --args "${WWW}/nsdf-group.json" --prefer local
python -m bokeh serve dashboards/app --dev --args "https://nsdf01.classe.cornell.edu/nsdf-group.json"

# this is for public access
python3 -m bokeh serve "dashboards/app" \
