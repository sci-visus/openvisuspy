...
if __name__.startswith('bokeh'):
	...
	parser.add_argument("--palette", type=str, required=False, default="Viridis256")
	...
	from openvisuspy.metadata import ShowMetadata
	view.metadata.children=[ShowMetadata(json.load(open("data.json"))["metadata"])]
